...
for epoch in range(num_epochs):
    ...
    with open('./outputs.csv', 'w', newline='') as fo:
        writero = csv.writer(fo)
        for rowo in outputs_all:
            writero.writerow(rowo)
    with open('./features.csv', 'w', newline='') as ff:
        writerf = csv.writer(ff)
        for rowf in features_all:
            writerf.writerow(rowf)
...
torch.save(net.state_dict(), 'pretrained_dict.pt')
'''
